          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <NavLink
                  v-if="$page.props.can.favorites"
                  :href="route('quotes.index', { amount: 3 })"
                ...
                <NavLink
                  v-if="$page.props.can.favorites"
                  :href="route('quotes.favorites', $page.props.auth.user.id)"
                  :active="route().current('quotes.favorites')"
                >
                  Favorite quotes
                </NavLink>
                <NavLink
                  v-if="$page.props.can.management_users"
